...
function App() {
  ...
  const alternarColoresBotones = (button) => {
    // set colors by default
    const buttonColors = {
      boton2: '#1B1D1F',
      boton3: '#1B1D1F',
    };
    // set color to the clicked button
    buttonColors[button] = '#6e7c80';
    
    setColorBotones(buttonColors);
    
    // set showAvailableOnly to true if the button is 'boton3', otherwise set it to false
    setShowAvailableOnly(button === 'boton3')
  };
